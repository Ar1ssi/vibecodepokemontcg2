// Generation 9 Pokémon sprites and the Paldea-era forms of older species.
// Art is fan-made in the pokesprite gen-8 box style (the pokesprite project
// stops at Hisui). It was sliced from a user-supplied sheet onto pokesprite's
// 68x56 canvas and vendored at client/src/assets/pokemon/gen9/regular/.
// There is no shiny art for these entries (D100).
