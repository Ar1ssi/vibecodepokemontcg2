...
const ATTACK_HEADER = /^(.*?)→\s*(.+?)(?:\s*:\s*([0-9]+\s*[+×xX-]?))?\s*$/;
const CARD_NOTE = /^\(this card cannot be used at official tournaments\.?\)$/i;
...
const STATIC_CARD_TEXT = /^you may play a pokémon card that evolves from .* on top of /i;
...
function isAttackHeaderPrefix(prefix) {
