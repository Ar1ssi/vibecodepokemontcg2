...
Focus: I141 — the measured ability backlog after design 034 (complete S287). Current
  runs/partial/dead/consumed/unconsumed/unparsed = 1675/257/62/1169/1064/1 (activation per the
  server gate, D130).
Active: I141 — when-played (D129), gate honesty (D130), triggers, repeatable abilities (D131).
Next: I143 (P2, chained follow-on steps); I141 — KO triggers, I142 between-turns, then the
...
- Two gates after engine ability changes: `pnpm audit:oracle` (~2 min, D108) and
  ...
  Re-ratchet only legit improvements. `pnpm test` baseline: 3499, 1 pre-existing fail
