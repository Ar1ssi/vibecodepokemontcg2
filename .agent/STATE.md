...
Session: 308
Focus: TCG Live FX from user clips: design 043 opponent Trainer/Stadium preview (D157) and design 044
  draws (D158) shipped to main S308.
Active: none. User visual check pending: 042 KO/discards, 043 opponent Trainer, 044 draws in a real game.
Next: remove worktree evolve-sv (merged; its out/ holds untracked videos, ask before --force). Maintenance
